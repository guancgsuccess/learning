            ...
            <div class="nk-bar">
                <div class="module-box">
                    <ul class="profile-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/company/questionPaper"  class="selected">
                    ...
                    <div class="js-tab-content">
                        <table class="no-border-table">
                            ...
                            <c:forEach items="${questionPaperList}" var="questionPaper" >
                                <tr>
                                    <td class="width"><c:out value="${questionPaper.questionPaperTitle}"></c:out></td>

                                    <td><a href="${pageContext.request.contextPath}/company/deletePaper/${questionPaper.questionPaperId}" class="rzzgr btn_sh">删除</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                        ...
                        <c:choose>
                            <c:when test="${questionPaperList!='[]'}">
                                <div class="page">
                                    <div class="pager">
                                        <span class="colac f1 pr10 lh30">当前${page.currentPageCode}/${page.totalPages}页</span>
                                        <div class="pagera_sh f1">
                                            <a href="${pageContext.request.contextPath}/company/questionPaper?page=${1}" class="disabled next">首页</a>
                                            <c:if test="${page.currentPageCode !=1}">
                                                <a href="${pageContext.request.contextPath}/company/questionPaper?page=${page.currentPageCode-1}" class="disabled next">上一页</a>
                                            </c:if>
                                            <c:if test="${page.currentPageCode != page.totalPages}">
                                                <a href="${pageContext.request.contextPath}/company/questionPaper?page=${page.currentPageCode+1}" class="disabled next">下一页</a>
                                            </c:if>
                                            <a href="${pageContext.request.contextPath}/company/questionPaper?page=${page.totalPages}" class="disabled next">末页</a>
                                        </div>
                                    </div>
                                </div>
                            </c:when>
